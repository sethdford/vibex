...
vi.mock('../utils/markdownUtilities', () => ({
  parseMarkdown: vi.fn().mockReturnValue({ nodes: [], images: [] }),
}));

vi.mock('../utils/MarkdownDisplay', () => ({
  MarkdownDisplay: vi.fn().mockImplementation(() => <div>Rendered markdown content</div>),
}));
