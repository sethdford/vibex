...
jest.mock('../../../src/ui/utils/highlighter.js', () => ({
  highlightCode: jest.fn((code: string, language: string) => code.split('\n'))
}));

jest.mock('../../../src/ui/colors.js', () => ({
  Colors: {
    AccentPurple: '#8B5CF6',
    Text: '#FFFFFF',
    AccentBlue: '#3B82F6',
...
describe('AdvancedStreamingDisplay', () => {
  ...
  describe('Interactive Mode', () => {
    ...
    test('should handle thinking block interactions', () => {
      const onThinkingInteraction = jest.fn();
