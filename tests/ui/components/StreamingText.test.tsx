...
describe('StreamingText Component', () => {
  ...
  it('shows full text immediately when switching from streaming to non-streaming', () => {
    ...
    act(() => {
      jest.advanceTimersByTime(300); // Show first 3 characters
    });
  ...
  it('handles different streaming speeds', () => {
    ...
    act(() => {
      jest.advanceTimersByTime(20); // Short time for fast speed
    });
    ...
    act(() => {
      jest.advanceTimersByTime(200); // Longer time for slow speed
    });
  });
